...
<h1 style="padding-left: 18px;padding-top: 18px;padding-bottom: 20px;">Clients</h1>

    <a href="https://www.keellssuper.com/welcome" target="_blank" >
          <img src="images/keels.png" width="250px" height="200px"style="padding-left: 50px; padding-bottom:50px" />
    </a>  

    <a href="https://arimaclanka.com/" target="_blank" >
          <img src="images/arimac.png" width="250px" height="200px" style="padding-left: 50px;padding-bottom:50px"/>
    </a>

    <a href="https://www.logitech.com/en-us" target="_blank" >
          <img src="images/logitech.png" width="250px" height="200px"style="padding-left: 50px;padding-bottom:50px"/>
    </a>

    <a href="https://www.infor.com/" target="_blank" >
          <img src="images/infor.png" width="250px" height="200px"style="padding-left: 50px;padding-bottom:50px"/>
    </a>
        
    <a href="https://www.peoplesbank.lk/online-banking-selection" target="_blank" >
          <img src="images/pb.png" width="250px" height="200px"style="padding-left: 50px;padding-bottom:50px"/>
    </a>

    <a href="https://www.kfc.lk/" target="_blank" >
          <img src="images/kfc.jpg" width="250px" height="200px"style="padding-left: 50px;padding-bottom:50px"/>
    </a>

    <a href="https://mysoftlogic.lk/" target="_blank"> 
          <img src="images/softlogic.jpg" width="250px" height="200px"style="padding-left: 50px;padding-bottom:50px"/>
    </a>
    
    <a href="https://www.hcl.com/" target="_blank" >
          <img src="images/hcl.png" width="250px" height="200px"style="padding-left: 50px;padding-bottom:50px"/>
    </a>

    <a href="https://www.philips.com/" target="_blank" >
          <img src="images/philips.png" width="250px" height="200px"style="padding-left: 50px;padding-bottom:50px"/>
    </a>

    <a href="https://bestcarepetshop.lk/" >
          <img src="images/petshop.jpg" width="250px" height="200px"style="padding-left: 50px;padding-bottom:50px"/>
    </a>
