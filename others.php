...
<fieldset   style="background:url(images/collage.jpg)no-repeat;background-size: cover;width:1342px;">
    <button class="listJ3"><a href="Job catergory.php" style="font-size: 25px; text-decoration: none; "><<</a></button>
      <b> <h1 class="listJ1"></h>Other</h1></b>
  ...
  <fieldset style="width:500px; margin-left: 100px;margin-bottom:15px;margin-top: 21px;background-color: rgb(144, 173, 177) ;border-radius: 10px">
    ...
    <ul class= "listJ">
        <li class= "listJ">(1) Driver <button  class="listJ2" ><a  href="Application form.php">Click here</a></button></li><br>
        <li class= "listJ">(2) telephone operator <button class="listJ2" ><a href="Application form.php">Click here</a></button></li><br>
        <li class= "listJ">(3) legal adviser <button class="listJ2" ><a href="Application form.php">Click here</a></button></li><br>
        <li class= "listJ">(4) Kitchen Helper <button class="listJ2" ><a href="Application form.php">Click here</a></button></li><br>
        <li class= "listJ">(5) Communication Coordinator <button class="listJ2" ><a href="Application form.php">Click here</a></button></li><br>
        <li class= "listJ">(6) repairer <button class="listJ2"> <a href="Application form.php">Click here</a></button></li><br>
        <li class= "listJ">(7) electrician <button class="listJ2"> <a href="Application form.php">Click here</a></button></li><br>
     </ul>
