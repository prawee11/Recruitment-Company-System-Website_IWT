<html>
    ...
    <fieldset   style="background:url(images/financial.jpg)no-repeat;background-size: cover;width:1342px;">
    <button class="listJ3"><a href="Job catergory.php" style="font-size: 25px; text-decoration: none; "><<</a></button>
      <b> <h1 class="listJ1"></h>Financial Jobs</h1></b>
  ...
  <fieldset style="width:500px; margin-left: 100px;margin-bottom:15px;margin-top: 21px;background-color: rgb(144, 173, 177) ;border-radius: 10px">
    ...
    <ul class= "listJ">
        <li class= "listJ">(1) Financial Advisor <button  class="listJ2" ><a  href="Application form.php">Click here</a></button></li><br>
        <li class= "listJ">(2) Assistant Accountant<button class="listJ2" ><a href="Application form.php">Click here</a></button></li><br>
        <li class= "listJ">(3) Accountant <button class="listJ2" ><a href="Application form.php">Click here</a></button></li><br>
        <li class= "listJ">(4) Finance Consultant <button class="listJ2" ><a href="Application form.php">Click here</a></button></li><br>
        <li class= "listJ">(5) Corporate Accountant <button class="listJ2" ><a href="Application form.php">Click here</a></button></li><br>
        <li class= "listJ">(6) Financial Analyst  <button class="listJ2"> <a href="Application form.php">Click here</a></button></li><br>
     </ul>
