<html>
    ...
    <fieldset   style="background:url(images/administrative-1.jpg)no-repeat;background-size: cover;width:1342px;">

      <button class="listJ3"><a href= "Job catergory.php" style="font-size: 25px; text-decoration: none; "><<</a></button>
      <b> <h1 class="listJ1"></h>Administrative Jobs</h1></b>

  <fieldset style="width:500px; margin-left: 100px;margin-bottom:15px;margin-top: 21px;background-color: rgb(144, 173, 177) ;border-radius: 10px">

    <ul class= "listJ">
        <li class= "listJ">(1) Office Assistant <button  class="listJ2" ><a  href="Application form.php">Click here</a></button></li><br>
        <li class= "listJ">(2) System Administrator <button class="listJ2" ><a href="Application form.php">Click here</a></button></li><br>
        
        <li class= "listJ">(3) HR manager<button class="listJ2" ><a href="Application form.php">Click here</a></button></li><br>
        <li class= "listJ">(4) Receptinist<button class="listJ2" ><a href="Application form.php">Click here</a></button></li><br>
        <li class= "listJ">(5) Junior Secretary<button class="listJ2" ><a href="Application form.php">Click here</a></button></li><br>
        <li class= "listJ">(6) Office Support Assistant<button class="listJ2" ><a href="Application form.php">Click here</a></button></li><br>
            ...
            <div class = "footer-heading footer-1">
              ...
              <div class="footer-heading footer-3">
               ...
               <div class="footer-heading footer-5">
                 <h2>Contacts</h2>
                    <input onClick="parent.location='feedback.php'" id="btn" type="button" value="FeedBack">
