<html>
    ...
    <h1 style="padding-left: 18px;padding-top: 18px;padding-bottom: 20px;">Partnership</h1>

  	<a href="#">
				<img src="images/images.png" width="250px" height="200px"style="padding-left: 50px; padding-bottom:50px" />
    </a>   
    
   <a href="#">
				<img src="images/teams.jpg" width="250px" height="200px" style="padding-left: 50px;padding-bottom:50px"/>
    </a>  

    <a href="#">
				<img src="images/partner.png"width="250px" height="200px"style="padding-left: 50px;padding-bottom:50px"/>
    </a> 

    <a href="#">
            <img src="images/visual.jpg"width="250px" height="200px"style="padding-left: 50px;padding-bottom:50px"/>
   </a> 
  
   <a href="#">
        <img src="images/images (1).png"width="250px" height="200px"style="padding-left: 50px;padding-bottom:50px"/>
    </a> 
    
    <a href="#">
        <img src="images/Logo1.jpg"width="250px" height="200px"style="padding-left: 50px;padding-bottom:50px"/>
    </a> 
   
    <a href="#"></a>
        <img src="images/lg.jpg"width="250px" height="200px"style="padding-left: 50px;padding-bottom:50px"/>
    </a> 
    
    <a href="#">
        <img src="images/download.png"width="250px" height="200px"style="padding-left: 50px;padding-bottom:50px"/>
    </a> 
    
    <a href="#">
      <img src="images/hiki.png"width="250px" height="200px"style="padding-left: 50px;padding-bottom:50px"/>
    </a> 

    <a href="#">
        <img src="images/load.png"width="250px" height="200px"style="padding-left: 50px;padding-bottom:50px"/>
    </a> 
